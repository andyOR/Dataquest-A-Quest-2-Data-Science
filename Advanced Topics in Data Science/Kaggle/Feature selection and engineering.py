...
bins = [0,12,50,100, 1000]
column_names = ["0-12","12-50","50-100","100+"]

train = process_fare(train, bins, column_names)
holdout = process_fare(holdout, bins, column_names)

train = create_dummies(train, "Fare_categories")
holdout = create_dummies(holdout, "Fare_categories")


## Engineering features from text column
...
## Traing the model using optimized column
